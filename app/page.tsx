      ...
      <main>
        <section id="hero" className="shell grid min-h-[calc(100vh-72px)] items-center gap-10 py-16 md:grid-cols-[1.02fr_0.98fr] md:py-24">
          <Reveal className="max-w-3xl">
            <p className="section-kicker mb-5 text-xs">Technical Game Designer // Unreal Engine Gameplay Systems</p>
            <h1 className="font-display text-5xl uppercase tracking-[0.08em] text-white md:text-7xl">Yash Menat</h1>
            <h2 className="mt-4 font-display text-2xl uppercase tracking-[0.12em] text-slate-200 md:text-3xl">Technical Game Designer</h2>
